...
- Site restyled to the halftone design system, with the spec's scroll motion, an animated circuit-board dither band in the footer, a first-run terminal transcript on the landing page, and an `llms.txt`.
